...
| [Usage](usage.md)                                | done        | Chat usage analytics with date range picker, task type filter, stacked-by-model cost charts, and thread-linked exchange history.                                                                                                      | [usage](usage.md)                             | 2026-04-06   |
...
| [User Preferences](user-preferences.md)          | done        | Multi-page settings layout at `/settings/` backed by a shared server-side preference store.                                                                                                                                           | [user-preferences](user-preferences.md)       | 2026-04-05   |
...
| [Board (Kanban)](board.md)                       | done        | Kanban board plugin with page at `/p/board`, dashboard widget, activity logging, and AI tools for task management.                                                                                                                    | [board](board.md)                             | 2026-04-05   |
| [Plugin System](plugins.md)                      | done        | Standardized plugin interface with dual-file registration, AI tools, settings, health checks, test connection, dashboard widgets, plugin pages, nav dropdown, and command palette.                                                    | [plugins](plugins.md)                         | 2026-04-05   |
...
| [Plugin — Radarr](plugin-radarr.md)              | done        | Radarr movie management via AI tools (10 tools: list/get movies, upcoming, queue, history, wanted, search/add, delete file, trigger search). JMESPath filtering. Phase 2 of \*arr stack.                                              | [plugin-radarr](plugin-radarr.md)             | 2026-04-06   |
| [Task Editor](task-editor.md)                    | in-progress | Dedicated task file editor with sectioned frontmatter display, visual cron builder, structured edit modal, new-task workflow, and AI critique. Phases 1–3 done, Phase 4 (AI critique) future work.                                    | [task-editor](task-editor.md)                 | 2026-04-06   |
