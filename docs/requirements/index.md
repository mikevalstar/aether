...
| [Task Editor](task-editor.md) | in-progress | Dedicated task file editor with sectioned frontmatter display, visual cron builder, structured edit modal, new-task workflow, and AI critique. Phases 1–3 done, Phase 4 (AI critique) pending. | [task-editor](task-editor.md) | 2026-04-05 |
