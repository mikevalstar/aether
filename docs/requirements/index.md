...
| [User Preferences](user-preferences.md) | done | Multi-page settings layout (profile, chat, notifications, calendar, plugins) at `/settings/`. | [user-preferences](user-preferences.md) | 2026-04-05 |
