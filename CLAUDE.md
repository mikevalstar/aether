...
### AI Chat
- **Models**: Defined in `src/lib/chat/chat-models.ts`. Anthropic: Claude Haiku 4.5 (default), Sonnet 4.6, Opus 4.6. OpenRouter: GLM-5, GLM-5.1, Kimi K2.5. MiniMax: M2.7, M3 (direct or via OpenRouter). Each model carries `supportsWebTools`, `supportsEffort`, `supportsCodeExecution`, `webToolVersion`, and USD pricing for cost tracking.
