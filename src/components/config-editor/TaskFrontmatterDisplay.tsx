...
import { BellIcon, BotIcon, CalendarClockIcon, HelpCircle } from "lucide-react";
...
export function TaskFrontmatterDisplay({ document, onRefresh }: TaskFrontmatterDisplayProps) {
  ...
  return (
    <div className="border-b border-[var(--line)] bg-[var(--surface-alt)] px-6 py-4 sm:px-8">
      <div className="space-y-4">
        {/* ── Schedule ── */}
        <Section title="Schedule" icon={CalendarClockIcon}>
        ...
        {/* ── AI Config ── */}
        <Section title="AI Config" icon={BotIcon}>
        ...
        <Section title="Notifications" icon={BellIcon}>
          <Field label="Notify" tooltip='Whether to send notifications on task completion. "notify" sends, "silent" skips.'>
