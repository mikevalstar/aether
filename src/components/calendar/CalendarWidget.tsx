							...
							const cell = (
								<button
									...
									className={cn(
										...
										selected &&
											!today &&
											"bg-accent ring-1 ring-[var(--teal)]",
										selected &&
											today &&
											"ring-1 ring-[var(--teal)] ring-offset-1 ring-offset-card",
									)}
								>
									<span
										className={cn(
							...
							if (hasEvents) {
								return (
									<Tooltip key={day.toISOString()}>
										...
										<TooltipContent
											side="bottom"
											className="max-w-[220px] space-y-0.5 p-2"
										>
											{dayEvents.slice(0, 5).map((e) => (
												...
												>
													...
													<span className="truncate">
														{e.allDay
															? e.title
															: `${format(new Date(e.start), "h:mm a")} ${e.title}`}
													</span>
												</div>
											))}
											{dayEvents.length > 5 && (
