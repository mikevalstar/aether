		...
		<div className="max-w-3xl space-y-10 p-6">
			<div>
				...
				<p className="text-sm text-muted-foreground">
					All colors use OKLCH and adapt to light/dark mode via CSS variables.
				</p>
			</div>
	...
	render: () => (
		<div className="max-w-3xl space-y-10 p-6">
			<div>
				...
				<p className="text-sm text-muted-foreground">
					Manrope for UI text, Fraunces for display headings.
				</p>
			</div>

			<Section title="Display (Fraunces)">
				<div className="space-y-4">
					<p className="display-title text-5xl font-bold tracking-tight">
						Display — 5xl Bold
					</p>
					<p className="display-title text-4xl font-bold tracking-tight">
						Display — 4xl Bold
					</p>
					<p className="display-title text-3xl font-bold tracking-tight">
						Display — 3xl Bold
					</p>
					<p className="display-title text-2xl font-bold tracking-tight">
						Display — 2xl Bold
					</p>
					<p className="display-title text-xl font-bold tracking-tight">
						Display — xl Bold
					</p>
				</div>
			</Section>
			...
			<Section title="Text Colors">
				<div className="space-y-2">
					<p className="text-foreground">
						text-foreground — Primary text (--ink)
					</p>
					<p className="text-muted-foreground">
						text-muted-foreground — Secondary text (--ink-soft)
					</p>
					<p className="text-primary">
						text-primary — Links &amp; accents (--teal)
					</p>
	...
	render: () => (
		<div className="max-w-3xl space-y-10 p-6">
			<div>
				...
				<p className="text-sm text-muted-foreground">
					Standard Tailwind 4px grid for spacing. Custom radius scale.
				</p>
			</div>
				...
				<div className="flex flex-wrap items-end gap-6">
					{[
						...
						<div key={label} className="flex flex-col items-center gap-1.5">
							<div
								className={`size-14 border-2 border-primary bg-secondary ${cls}`}
							/>
	...
	render: () => (
		<div className="max-w-3xl space-y-10 p-6">
			<div>
				...
				<p className="text-sm text-muted-foreground">
					Reusable surface classes and layout patterns used across the app.
				</p>
			</div>

			<Section title="Surface Card">
				<p className="mb-3 text-sm text-muted-foreground">
					<code>.surface-card</code> — Card background, border, and radius. Used
					for content containers.
				</p>
				<div className="surface-card p-6">
					<p className="text-sm font-semibold">Card Title</p>
					<p className="mt-1 text-sm text-muted-foreground">
						Card content using the surface-card utility class.
					</p>
				</div>
			</Section>
			...
			<Section title="Page Wrap">
				<p className="mb-3 text-sm text-muted-foreground">
					<code>.page-wrap</code> — Max 1560px, centered, with responsive side
					padding. Applied to page content containers.
				</p>
			...
			<Section title="Feature Grid">
				<p className="mb-3 text-sm text-muted-foreground">
					Border-separated grid using <code>bg-border gap-px</code> with
					card-colored children.
				</p>
			...
			<Section title="Page Header Pattern">
				<p className="mb-3 text-sm text-muted-foreground">
					Consistent page header: overline, display title, subtitle.
				</p>
				<div className="rounded-lg border border-dashed border-border p-6">
					...
					<p className="mt-2 text-sm text-muted-foreground">
						Subtitle or description text explaining this section.
					</p>
				</div>
			</Section>
			...
			<Section title="Nav Link">
				<p className="mb-3 text-sm text-muted-foreground">
					<code>.nav-link</code> — Muted text with animated underline on hover.{" "}
					<code>.is-active</code> for current page.
				</p>
