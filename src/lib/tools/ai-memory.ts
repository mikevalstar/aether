...
Memory subfolders: notes/ (preferences, people, project context), templates/ (reusable formats), tasks/ (how-to instructions), workflows/ (multi-step processes).`,
  inputSchema: z.object({
    search: z.string().optional().describe("Keyword to search by title, path, or tags. Omit to list all memories."),
    subfolder: z.string().optional().describe("Scope to 'notes', 'templates', 'tasks', or 'workflows'"),
  }),
