...
function ChatPage() {
  ...
  return (
    <main className="page-wrap flex h-[calc(100dvh-1.75rem-env(safe-area-inset-top))] min-h-0 px-0 py-0 lg:h-[calc(100dvh-4.5rem-env(safe-area-inset-top))] lg:min-h-[500px] lg:px-4 lg:py-2">
